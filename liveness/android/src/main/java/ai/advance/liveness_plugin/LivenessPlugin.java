...
public class LivenessPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        mMethodChannel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "liveness_plugin");
        mMethodChannel.setMethodCallHandler(new LivenessPlugin());
    }
    ...
    private void initSDK(MethodCall methodCall, Result result) {
        ...
        if (market != null) {
            ...
            GuardianLivenessDetectionSDK.init(application, accessKey, secretKey, market);
    ...
    private void initSDKOfLicense(MethodCall methodCall, Result result) {
        ...
        if (market != null) {
            LogUtil.sdkLogE("market:" + market);
            GuardianLivenessDetectionSDK.init(application, market);
            GuardianLivenessDetectionSDK.letSDKHandleCameraPermission();
    ...
    public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
        ...
        LivenessPlugin.binding = binding;
    }
